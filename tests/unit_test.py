...
API_BASEURL = "https://pmc-1882.usr.yandex-academy.ru"
...
def test_import():
    ...
    print("Test import passed.", max(times))
...
def test_nodes():
    ...
    print("Test nodes passed.", finish - start)
...
def test_updates():
    ...
    finish = datetime.now()
    assert status == 200, f"Expected HTTP status code 200, got {status}"
    print("Test updates passed.", finish - start)
...
def test_history():
    ...
    finish = datetime.now()
    assert status == 200, f"Expected HTTP status code 200, got {status}"
    print("Test stats passed.", finish - start)
...
def test_delete():
    ...
    print("Test delete passed.", max(first_time, finish - start))

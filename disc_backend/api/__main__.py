...
from disc_backend.api.app import create_app
from disc_backend.utils.custom_argparse import clear_environ, positive_int
from disc_backend.utils.pg import DEFAULT_PG_URL


ENV_VAR_PREFIX = 'DISC_'
...
group.add_argument('--pg-pool-min-size', type=int, default=100,
                   help='Minimum database connections')
group.add_argument('--pg-pool-max-size', type=int, default=110,
